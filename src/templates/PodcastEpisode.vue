            ...
            actor: [
              {
                "@type": "Person",
                affiliation: "Tech Jr",
                description: "Lee is a tenacious and motivated web developer that is passionate about User Experience (UX/UI).",
                familyName: "Warrick",
                givenName: "Lee",
              ...
              },
              {
                "@type": "Person",
                affiliation: "Tech Jr",
                description: "Full Stack Developer and web/print designer with over 15 years of industry experience. Versed in web languages such as HTML5, CSS3, JavaScript, jQuery, Node JS, Express JS, Handlebars JS, and Adobe certified in Photoshop and Dreamweaver. ",
                familyName: "Otero",
                givenName: "Edwin",
